...
def build_hello_email():
    ...
    message = Mail(
        from_email=From("from@gaggle.dev", "Example From Name"),
...
def get_mock_personalization_dict():
    ...
    mock_pers["cc_list"] = [
        To("test3@example.com", "Example User"),
        To("test4@example.com", "Example User"),
    ]
...
def build_multiple_emails_personalized():
    ...
    message = Mail(
        from_email=From("from@example.com", "Example From Name"),
        subject=Subject("Sending with SendGrid is Fun"),
        plain_text_content=PlainTextContent(
            "and easy to do anywhere, even with Python"
        ),
...
def build_kitchen_sink():
    ...
    message.header = [Header("X-Test3", "Test3", p=0), Header("X-Test4", "Test4", p=0)]
    ...
    message.header = [Header("X-Test7", "Test7", p=1), Header("X-Test8", "Test8", p=1)]
